...
const HRDashboard = ({ navigation }) => {
  ...
  const handleApproval = async (applicationId) => {
    try {
      ...
      await updateDoc(applicationRef, {
        status: "approved by HR", // Update to 'approved by HR' when HR approves
        reviewHistory: [...applicationData.reviewHistory, "HR approved"], // Update review history
      });
  ...
  const handleRejection = async (applicationId) => {
    try {
      ...
      await updateDoc(applicationRef, {
        status: "rejected", // Update to 'rejected' when HR rejects
        reviewHistory: [...applicationData.reviewHistory, "HR rejected"], // Update review history
      });
  ...
  return (
    ...
    <View style={styles.container}>
      <Text style={styles.title}>Leave Applications for HR Approval</Text>
      <TouchableOpacity
